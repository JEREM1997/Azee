/*
  ...
  1. Changes
    ...
    - Add policies for different user roles:
      ...
      - Production users can access all plans
      - Store users can only access plans for their assigned stores
    - Enable RLS on store_productions table
    - Add corresponding policies for store_productions

  2. Security
    - Ensures proper data access control based on user roles
    - Prevents unauthorized access to production data
    - Maintains data isolation between stores
*/
