/*
  ...
  1. Changes
    - Drop all existing policies for donut_forms to avoid conflicts
    - Create new policies with proper role checks
    - Ensure proper column defaults
    - Grant necessary permissions
    
  2. Security
    - Maintain RLS on donut_forms table
    - Fix permission issues for admin users
*/
...
-- Create clean policies for donut_forms with proper role checks
...
-- Disable RLS temporarily to ensure admin can access the table
