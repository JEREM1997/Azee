...
const KrispyKremeLoader: React.FC<KrispyKremeLoaderProps> = ({
  ...
  const content = (
    ...
    >
      ...
      >
        <defs>
          <linearGradient id="kk-dough" x1="15" y1="12" x2="57" y2="61" gradientUnits="userSpaceOnUse">
            <stop stopColor="#D99A47" />
            <stop offset="1" stopColor="#A96225" />
          </linearGradient>
          <linearGradient id="kk-glaze" x1="20" y1="14" x2="54" y2="55" gradientUnits="userSpaceOnUse">
            <stop stopColor="#FFF8E9" />
            <stop offset="1" stopColor="#E8D3AE" />
          </linearGradient>
          <filter id="kk-depth" x="-12%" y="-12%" width="124%" height="130%">
            <feDropShadow dx="0" dy="2" stdDeviation="1.5" floodColor="#633914" floodOpacity=".2" />
          </filter>
          <mask id="kk-hole">
            <rect width="72" height="72" fill="white" />
            <path d="M28.4 35.7c.1-5 3.2-8.1 7.7-8.2 4.8-.1 7.9 3.2 7.7 8.3-.2 5-3.1 8.1-7.7 8-4.7 0-7.8-3.1-7.7-8.1Z" fill="black" />
          </mask>
        </defs>
        <g filter="url(#kk-depth)" mask="url(#kk-hole)">
          <path fill="url(#kk-dough)" d="M62 35.7c.1 15.3-10.2 26.5-25.7 26.8C20.6 62.8 9.8 52.3 10 36.4 10.2 20.8 20.7 9.8 36 9.5c15.6-.2 25.9 10.5 26 26.2Z" />
          <path fill="url(#kk-glaze)" d="M58.9 31.5c.3 4.5-2.5 4.6-3.9 7.8-1.3 3.1.3 5.4-2.9 8.5-3.4 3.4-6.7 1.9-10 4.5-2.5 2-4.1 4.6-8.7 3.7-4.4-.9-4.8-4-8.2-5.4-3.7-1.4-6.3.3-8.6-3.8-2.2-3.8.3-6.1-.8-9.7-1-3.3-3.5-4.9-1.5-9.2 2-4.1 5.2-3.3 7.7-6.2 2.2-2.7 1.8-5.8 6.4-7.1 4.3-1.3 5.9 1.5 9.5 1.6 3.7.1 5.4-2.5 9.3-.5 4.1 2 3.2 5.2 6.2 7.5 2.7 2.1 5.2 3.8 5.5 8.3Z" />
