/*
  # Update User Roles Schema for Multiple Stores

  1. Changes
    - Modify user_roles table to support multiple store IDs
    - Update sync_user_role function for new store_ids array
    - Update policies for store-related tables
    
  2. Security
    - Maintain existing RLS
    - Update policies to check against store_ids array
*/
